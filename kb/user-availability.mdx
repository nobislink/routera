...
### Editing Your Own Availability

To set your own availability, go to **Settings** <Icon icon="gear" /> in the upper-right corner of your screen, then click **Working Hours**. The screen will display the following sections:
